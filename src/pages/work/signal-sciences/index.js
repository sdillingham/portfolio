        ...
        <Grid gap={3} columns={[12]} sx={{ mb: [4, 6, 6] }}>
          ...
          <Box
            ...
            <Text sx={{ variant: "texts.workBodyDark" }}>
              ...
              <p>In 2019, we switched to Figma, completely <a href="https://building.signalsciences.com/color-design-system/">refreshed the visual design</a> of our entire system, and refactored all our React components using Styled System and Styled Components. We <a href="https://building.signalsciences.com/B2B-content-strategy/">invested heavily in content strategy</a>, creating editorial guidelines that define our voice and tone, product glossary, grammar, mechanics, and preferred terms.</p>
            </Text>
          </Box>
          <Box
            sx={{
